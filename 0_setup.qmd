...
#------------------------------
# 5. Verify you’re using the env’s perl:
#------------------------------
which perl
# → /home/kimd/miniforge3/envs/aodp-training/bin/perl

# Test Bioperl:
perl -MBio::Seq -e 'print "Bioperl is working\n";'

# If you still see “Can’t locate Bio/Seq.pm in @INC”, force-prepend the env’s bin:
export PATH="$CONDA_PREFIX/bin:$PATH"
hash -r   # clear bash’s command cache

# Re-check and re-test:
which perl
# → should now again be $CONDA_PREFIX/bin/perl
perl -MBio::Seq -e 'print "Bioperl is working\n";'

# list installed perl packages and their versions
conda list perl-bioperl

#------------------------------
# 6. Install AODP locally
# Install AODP by following the instruction in "INSTALL" file.
#------------------------------

# Switch to aodp folder
cd aodp_v2.0_release

# Extract and enter AODP folder
...
#------------------------------
# 7. check other software installed, 
#------------------------------
