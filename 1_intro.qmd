...
The annotated maximum likelihood (ML) tree of the CR-ITS2-refDB database is shown in @fig-refDB, while the intra- and inter-specific variation distributions are shown in @fig-var.
